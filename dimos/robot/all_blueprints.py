...
all_modules = {
    ...
    "g1-mujoco-connection": "dimos.robot.unitree.g1.mujoco_sim.G1MujocoConnection",
    "g1-web-rtc-connection": "dimos.robot.unitree.g1.connection.G1WebRtcConnection",
    ...
    "go2-mujoco-connection": "dimos.robot.unitree.go2.connection_mujoco.Go2MujocoConnection",
    "go2-replay-connection": "dimos.robot.unitree.go2.connection_replay.Go2ReplayConnection",
    "go2-web-rtc-connection": "dimos.robot.unitree.go2.connection_webrtc.Go2WebRtcConnection",
    ...
    "mujoco-connection-base": "dimos.robot.unitree.mujoco_connection.MujocoConnectionBase",
